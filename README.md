...
| Admin | `admin status`, `admin users`, `admin teams`, `admin hostings`, `admin mailbox list`, `admin mailbox show`, `admin mailbox alias add/remove`, `admin mailbox forwarding show/add/remove/set/disable`, `admin mailbox signature list/show/create/update/set-default/delete`, `admin mailbox settings show/set`, `admin mailbox sender block/unblock/allow/unallow` |
