...
![version](https://img.shields.io/badge/version-0.3.1-blue) ![license](https://img.shields.io/badge/license-MIT-green) ![python](https://img.shields.io/badge/python-%3E%3D3.11-blue) ![platform](https://img.shields.io/badge/platform-windows%20%7C%20linux%20%7C%20mac-lightgrey)
...
| Admin | `admin status`, `admin users`, `admin hostings`, `admin mailbox list`, `admin mailbox show`, `admin mailbox alias add/remove` |
