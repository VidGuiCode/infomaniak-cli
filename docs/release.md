...
```bash
pipx install https://github.com/VidGuiCode/infomaniak-cli/releases/download/v0.1.14/infomaniak_cli-0.1.14-py3-none-any.whl --backend pip
```
...
```bash
uv build
pipx install --force --backend pip dist/infomaniak_cli-0.1.14-py3-none-any.whl
ik version
ik --help
