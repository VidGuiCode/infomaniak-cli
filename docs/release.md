...
```bash
pipx install https://github.com/VidGuiCode/infomaniak-cli/releases/download/v0.1.3/infomaniak_cli-0.1.3-py3-none-any.whl
```
...
```bash
uv build
pipx install --force dist/infomaniak_cli-0.1.3-py3-none-any.whl
ik version
ik --help
